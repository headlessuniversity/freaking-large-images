...
function JezaelImage({ queryString = "" }: { queryString?: string }) {
  return (
    <img
      src={`https://images.ctfassets.net/14fez5s3hrmy/ysZqMA6Oy9HbaYKnQcXXp/25ac3869e3b830f887dcd9908015f131/jezael-melgoza-layMbSJ3YOE-unsplash.jpg${queryString}`}
...
function NasaImage({ queryString = "" }: { queryString?: string }) {
  return (
    <img
      src={`https://images.ctfassets.net/14fez5s3hrmy/6TF4uKd8b72TBhNRWRBRzt/21a8deb85e80e432c43edd48ef5b1255/nasa-rTZW4f02zY8-unsplash.jpg${queryString}`}
...
function PhcImage1({ queryString = "" }: { queryString?: string }) {
  return (
    <img
      src={`https://images.ctfassets.net/14fez5s3hrmy/6z0Rzfl7NFPao5iFVLsoA5/c73aa5e41798c532c94ecbfd830c417f/phc-software-3nSnUNGTUqo-unsplash.jpg${queryString}`}
...
function PhcImage2({ queryString = "" }: { queryString?: string }) {
  return (
    <img
      src={`https://images.ctfassets.net/14fez5s3hrmy/4axEyF0Az0QeLv0V3wICcn/01d608c503905997bf7032d739f67e53/phc-software-Q0ClVjV8ts0-unsplash.jpg${queryString}`}
